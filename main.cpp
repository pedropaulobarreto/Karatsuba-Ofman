...
#define vec 10                      //quantidade de execucoes do loop for
...
int main()
{
    ...
    double t1[vec], t2[vec], media1, media2;//Variaveis de controle de tempo de cada execucao
...
//=========================Laco principal do codigo===============================\\
    ...
    for(int i=0;i<vec;i++)
    {
        ...
        if(normal == kara) hits++; //Compara de os metodos obteram o mesmo resultado
...
//======================================================
    ...
    cout<<"Quantidade de execucoes testadas                      =  "<<vec<<"\n";
    cout<<"Quantidade de acertos do metodo karatsuba-ofman       =  "<<(100.0*hits/vec)<<"%\n";
